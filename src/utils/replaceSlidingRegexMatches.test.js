...
describe('utils/replaceSlidingRegexMatches', () => {
  it('should correctly mask a cardnummer', () => {
    expect(replaceSlidingRegexMatches('5420923878724339', replaceIfCardNumber, new CardNumberRegExp(16)))
      .toEqual('5420********4339');
  });
  ...
  it('should correctly mask a cardnummer with all regex options', () => {
    ...
    expect(replaceSlidingRegexMatches('5420923878724339', replaceIfCardNumber, cardNumberRegex))
      .toEqual('5420********4339');
  });
